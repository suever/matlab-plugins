classdef Updater < hgsetget
    ...
    methods
        function self = Updater(varargin)
            ...
            inputs = plugins.Updater.parseinputs(varargin{:});
            set(self, inputs)
    ...
    methods (Static)
        ...
        function inputs = parseinputs(varargin)
            ...
            ip.addParamValue('Config', plugins.structobj(), @isstruct);
        ...
        function obj = create(varargin)
            ...
            updaters = plugins.PluginManager.findAllPlugins(thisclass, 'plugins.updaters');
